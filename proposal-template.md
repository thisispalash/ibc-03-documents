...
> Blockchain enables secured, tamper-evident, auditable, privacy-preserving system to issue and 
> verify Certificates / Resolutions issued by government / authorized agencies so that third 
> parties (banks, universities, welfare departments, citizens etc) can instantly verify them 
> avoiding intermediaries. The system should enhance transparency, reduce frauds and eliminate the 
> burden of manual verification. The system can be much more than just a issue of final static 
> certificate. It should be able record the entire lifecycle of the document, every step from 
> creation and drafting, to internal reviews, approvals, signatures, issuance etc.
